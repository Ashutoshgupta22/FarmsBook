...
class CropsFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.myCrops.observe(viewLifecycleOwner) {
            ...
            Log.i("CropsFragment", "onViewCreated: " +
                    "myCrops Updated size:${it.size}")
        ...
        viewModel.cropAdded.observe(viewLifecycleOwner) {
            it?.let {
                if(it) {
                    ...
                    Log.i("CropsFragment", "onViewCreated: crop added")
                    viewModel.getMyCrops(requireContext(), currentAdmin.id!!)
                    viewModel.getAllCrops(requireContext())
                    showAddImageDialog()
                }
        ...
        binding.fabAddCrop.setOnClickListener{
            ...
            MaterialAlertDialogBuilder(requireContext())
                ...
                .setPositiveButton("Add") {
                    ...
                    if (name.isBlank()) {
                        Toast.makeText(requireContext(), "Name can not be empty",
        ...
        MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton("Save") {
                ...
                if (ivDialogImage.drawable == null){
                    Toast.makeText(requireContext(), "Select an image",
                        Toast.LENGTH_SHORT).show()

                }
                else {
                    imageUri?.let {
                        viewModel.addCropImage(requireContext(),
                            currentAdmin.id!!, it)
                    }
                }
            }
