...
class ListedCropViewModel: ViewModel() {

    private var _allListedCrops = MutableLiveData<ArrayList<ListedCropData>>()
    val allListedCrops: LiveData<ArrayList<ListedCropData>> = _allListedCrops

    private val baseUrl = BaseAddressUrl().baseAddressUrl

    fun getAllListedCrops(context: Context?) {
        ...
        val request = JsonArrayRequest(
            ...
            url, null, { response: JSONArray ->
                ...
                for (i in 0 until response.length()) {
                    ...
                    val userDp = cropObj.optString("userDp",
                    ...
                    val listedCropData = ListedCropData(
                        ...
                        userDp, imageUrls, images, user, listedOfferList
                    )
