...
class ManageCropAdapter2 (private val plantList : ArrayList<ManageCropData>, val context: Context):RecyclerView.Adapter<ManageCropAdapter2.Myviewholder> () {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Myviewholder {
        ...
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.manage_crop_list_item2,parent,false)
