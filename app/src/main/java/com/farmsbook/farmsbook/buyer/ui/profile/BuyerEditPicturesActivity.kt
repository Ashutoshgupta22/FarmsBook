...
import com.farmsbook.farmsbook.databinding.ActivityBuyerEditPicturesBinding
...
class BuyerEditPicturesActivity : AppCompatActivity() {
    private lateinit var binding : ActivityBuyerEditPicturesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityBuyerEditPicturesBinding.inflate(layoutInflater)
